  ...
  return (
    ...
    <div className="h-screen bg-theme">
          ...
          >
            ...
            <div className="font-bold text-white md:px-5">
              <h1 className="text-7xl md:text-4xl" data-aos='slide-right'>
                Hii , I am <b className="text-green-500">Hritik Rathore</b>
              </h1>
              <h1 className="text-4xl md:text-xl" data-aos='slide-left'>
                FullStack <b className="text-orange-500">Developer</b> , Instructor, <b className="text-red-500">Freelancer</b>
              </h1>
            </div>
          </div>
          </div>
        ...
        <div className="mt-20">
          ...
          <div className="text-center h-52 bg-primary">
            <h1 className="text-white font-bold text-4xl py-10">
              YES YOU ARE RIGHT, THIS IS JavaScript Buff.......
            </h1>
          </div>
          ...
          <div className="text-center h-52 bg-blue-500">
            <h1 className="text-white font-bold text-4xl py-10">
              My full Stack web Developer
            </h1>
          </div>

          <div className="md:mx-5 mx-32 shadow-2xl bg-gray-50 -mt-20 rounded-lg hover:bg-pink-700 hover:text-white">
            <div className="h-96" data-aos='zoom-in'>
              <lottie-player
        ...
        <div>
          ...
          <div className="h-screen relative text-orange-800">
